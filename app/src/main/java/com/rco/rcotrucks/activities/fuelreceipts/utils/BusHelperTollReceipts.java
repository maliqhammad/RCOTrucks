...
public class BusHelperTollReceipts extends BusHelperRmsCoding {
    private static final String TAG = BusHelperTollReceipts.class.getSimpleName();
    ...
    public static BusHelperTollReceipts instance;
    ...
    public static void setContext(Context context) {
        BusHelperTollReceipts.context = context;
    }

    private static Context context;

    public BusHelperTollReceipts(DatabaseHelper db) {
        super(db);
...
//        rmsRecordTypesUrlEncoded = urlEncodeCommaDelimited(RMS_CODINGDATA_RECORD_TYPES).toString();
    ...
    public static synchronized BusHelperTollReceipts instance() {
        // Todo: conditionally instantiate instance.
        if (instance == null) instance = new BusHelperTollReceipts(RecordRulesHelper.getDb());
     ...
     */
    public boolean initTollReceiptCodingSetup(boolean isAlreadyInTransaction) {
...
//                {Crms.ODOMETER, Crms.D_NUMERIC, String.valueOf(Cadp.VIEWTYPE_HDR_FLD)},
                ...
                {Crms.TOLL_ROAD_NAME, Crms.D_STRING, String.valueOf(Cadp.VIEWTYPE_HDR_FLD)},
        ...
        rulesRmsCoding.addCodingDataSetup(Crms.R_TOLL_RECEIPT, arCodingDataSetup, isAlreadyInTransaction);
    ...
    public static void initRmsConvenienceMembers() {
        BusHelperRmsCoding.RmsRecordType rtype = BusinessRules.getMapRecordTypeInfoFromRecordTypeName().get(Crms.R_TOLL_RECEIPT);
        if (rtype == null)
            return;
    ...
    public void syncFuelReceiptItems() throws Exception {
        ...
        String response = Rms.getRecordsUpdatedXFiltered(Crms.R_TOLL_RECEIPT, -5000,
                Crms.DRIVER_FIRST_NAME + "," + Crms.DRIVER_LAST_NAME, "%2C",
                user.getFirstName() + "," + user.getLastName(), "%2C%3B",
                Crms.DATETIME + "," + Crms.TRUCK_NUMBER + "," + Crms.RECORDID);
...
//                cursor = db.getQuery(strSql, new String[]{String.valueOf(idRmsRecordsFuelReceiptDtl), Crms.R_FUEL_RECEIPT});
                cursor = rulesRmsCoding.getRmsRecordCursor(String.valueOf(idRmsRecordsFuelReceiptDtl), Crms.R_TOLL_RECEIPT);
...
//                cursor = db.getQuery(strSql, new String[]{Crms.R_FUEL_RECEIPT});
                cursor = rulesRmsCoding.getNewRmsRecordCursor(Crms.R_TOLL_RECEIPT);
//                rulesRmsCoding.getNewRmsRecordCursorUpdate(Crms.R_FUEL_RECEIPT);
            ...
            listFuelReceiptDetail = loadTollReceiptDtlItemsFromDatabase(ctx, idRmsRecordsFuelReceiptDtl, objectIdFuelReceiptDetail,
...
//    private static String[] FROM_DATE_TIME_FORMAT_LIST = {DateUtils.FORMAT_DATE_TIME_MILLIS, DateUtils.FORMAT_ISO_SSS_Z};
     ...
     * @throws Exception
     */
    public List<ListItemCodingDataGroup> loadTollReceiptDtlItemsFromDatabase(
        ...
        String strThis = "CreateTollReceipt: loadTollReceiptDtlItemsFromDatabase(), ";
...
//                DateUtils.FORMAT_DATE_TIME_MILLIS, DateUtils.FORMAT_DATE_TIME_MILLIS);
        ...
        Log.d(TAG, strThis + "DOCUMENT_TITLE: loadTollReceiptDtlItemsFromDatabase: cmidDocumentTitle: " + cmidDocumentTitle);
...
//        listItems.clear();
        ...
        Log.d(TAG, "loadTollReceiptDtlItemsFromDatabase: cursor: size: "+cursor.getCount());
        int irow = 0;
...
//                    codingvalue = DateUtils.getDateTime(System.currentTimeMillis(), DateUtils.FORMAT_DATE_MM_DD_YYYY);
                ...
                Log.d(TAG, strThis+"loadTollReceiptDtlItemsFromDatabase: codingvalue: "+codingvalue);
...
//                    rmsRecId.idRmsRecords = idRmsRecords;
    ...
    public void runSaveFuelReceiptDtlTask(final CreateTollReceipt activity, final long idRmsRecords,
...
//            e.printStackTrace();
    ...
    public String sendPendingFuelReceipts(List<BusHelperRmsCoding.RmsRecordCoding> list) throws Exception {
        ...
        jsonReturn = RmsHelperTollReceipts.setTollReceipts(list);
...
//    }
    ...
    private BusHelperTollReceipts.FuelReceiptExtraPostProcessor fuelReceiptExtraPostProcessor;

    public BusHelperTollReceipts.FuelReceiptExtraPostProcessor getFuelReceiptExtraPostProcessor() {
        if (fuelReceiptExtraPostProcessor == null)
            fuelReceiptExtraPostProcessor = new BusHelperTollReceipts.FuelReceiptExtraPostProcessor();
