...
import com.rco.rcotrucks.custom_image.CaptureReceiptPhoto;
...
//                            Intent intent = new Intent(ImagePickerActivity.this, CustomImageRecorder.class);
//                            Intent intent = new Intent(ImagePickerActivity.this, CameraStencilActivity.class);
                            Intent intent = new Intent(ImagePickerActivity.this, CaptureReceiptPhoto.class);
//                            intent.putExtra("title", responseTitle);
            ...
            case REQUEST_PHOTO_CAPTURE:
                if (resultCode == RESULT_OK) {
                    Uri imageUri = Uri.parse(
                            new File(data.getStringExtra("" + ImagePickerActivity.REQUEST_PHOTO_CAPTURE)).toString());
...
//
////        options.setCropFrameColor(getResources().getColor(R.color.red));
...
////            options.withAspectRatio(false);
////        July 14, 2022 -   It will allow us to crop the image in any aspect without any default values
